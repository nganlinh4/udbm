...
export function t(key, options = {}) {
    ...
    const fallbackTranslations = {
        ko: {
            ...
            'database.smartOrder': '스마트정렬',
            'database.smartOrderTooltip': '외래 키를 기준으로 테이블을 정렬합니다',
        ...
        en: {
            ...
            'database.smartOrder': 'Smart Order',
            'database.smartOrderTooltip': 'Order tables by foreign keys',
        ...
        vi: {
            ...
            'database.smartOrder': 'Sắp xếp thông minh',
            'database.smartOrderTooltip': 'Sắp xếp bảng theo khóa ngoại',
